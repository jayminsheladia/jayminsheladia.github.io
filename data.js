...
const PORTFOLIO = {
  ...
  education: [
    {
      ...
      note: "Coursework: Analysis of Algorithms, Database Systems, Web Technologies, Applied NLP, Agentic AI Systems",
    },
    {
  ...
  skills: {
    ...
    "Tools": ["Git", "GitHub Actions", "Docker", "VS Code", "PyCharm", "Jupyter Notebook", "Postman"],
    "Concepts": [
